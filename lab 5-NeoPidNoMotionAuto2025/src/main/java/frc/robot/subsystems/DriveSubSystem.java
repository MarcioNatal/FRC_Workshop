...
public class DriveSubSystem extends SubsystemBase 
{
  ...
  public DriveSubSystem() 
  {
    ...
    motorEncoder = motorSpark.getEncoder();
     ...
     initializeMotors();
      ...
      SmartDashboard.putNumber("Position1", 0);
      SmartDashboard.putNumber("Position2", 0);
      SmartDashboard.putNumber("Position3", 0);
  ...
  public void initializeMotors()
  {
    ...
    globalConfig.closedLoop
                ...
                .p(0.002,ClosedLoopSlot.kSlot0)
                .i(kI,ClosedLoopSlot.kSlot0)
                .d(kD,ClosedLoopSlot.kSlot0)
                .velocityFF(kFF,ClosedLoopSlot.kSlot0)
                .maxOutput(kMaxOutput,ClosedLoopSlot.kSlot0)
                .minOutput(kMinOutput,ClosedLoopSlot.kSlot0)
