...
public class SubsystemM10 extends SubsystemBase 
{
  private final CANSparkMax motoSparkMax ;
  private final RelativeEncoder mEncoder;
  //Constantes motor
  private final int kMotorID=10;
  ...
  public SubsystemM10() 
  {
    ...
    SmartDashboard.putNumber("Parametro Movimento/ SetPoint Voltas M10",0);
  ...
  public void periodic() 
  {
    ...
    SmartDashboard.putNumber("Corrente do Motor M10", this.getMotorCurrent());

    //retorna unidades de rotaçao 
    SmartDashboard.putNumber("Posiçao do encoder M10", mEncoder.getPosition());

    //mostra a velocidade em rpm
    SmartDashboard.putNumber("Velocidade do encoder M10", mEncoder.getVelocity());
