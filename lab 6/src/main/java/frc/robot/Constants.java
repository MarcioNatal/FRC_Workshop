 ...
 */
 ...
 public final class Constants 
 {
  ...
  public static final class ModuleConstants 
  {
       ...
       * ************************************************************/
      public static final double driveKS = 0.1; //0.32;  // Add 0.1 V output to overcome static friction
      ...
      public static final double driveKA = 0.11;  //0.27;
        ...
        //11,69%
      public static final double kPdriving = 0.0665;//ANTERIOR 0,0665 ; 0.05872615 // kP = 0.11 An error of 1 rps results in 0.11 V output
  ...
  *************************************************************/
  ...
  {
      public static final double kMaxSpeedMetersPerSecond = DriveConstants.kPhysicalMaxSpeedMetersPerSecond / 3;  //4
      ...
      public static final double kMaxAngularAccelerationRadiansPerSecondSquared = Math.PI / 0.5; //4
